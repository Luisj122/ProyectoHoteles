<nav x-data="{ open: false }" class="bg-danger text-white-500 border-b border-gray-100 ">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                @else
                    <a href="{{ route('login') }}" class="font-semibold text-white hover:text-gray-900">Log in</a>
                    @if (Route::has('register'))
                        <a href="{{ route('register') }}" class="ml-4 font-semibold text-white hover:text-gray-900">Register</a>
                    @endif
                @endauth
            </div>
